...
public class ScannerActivity extends AppCompatActivity {
    ...
    private void initComp() {
        ...
        //Tüm barkodları ve QR Okumak için Barcode Detector olustur...
        ...
        cameraSource = new CameraSource.Builder(ScannerActivity.this, barcodeDetector).setFacing(CameraSource.CAMERA_FACING_BACK).setRequestedFps(35.0f).setAutoFocusEnabled(true).setRequestedPreviewSize(680, 480).build();
