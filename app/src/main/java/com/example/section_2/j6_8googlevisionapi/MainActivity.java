...
public class MainActivity extends AppCompatActivity {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == RC_CAMERA){
            if (grantResults[0] != PackageManager.PERMISSION_GRANTED)
                Toast.makeText(this,"Kamera izni vermelisiniz",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void initComp(){
        ...
        btnTara= (Button) findViewById(R.id.btnAra);
        btnTara.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(ActivityCompat.checkSelfPermission(MainActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED){
                    Toast.makeText(MainActivity.this,"Kamera iznin olmadan buradan gecemessin",Toast.LENGTH_SHORT).show();
                    return;
                }
